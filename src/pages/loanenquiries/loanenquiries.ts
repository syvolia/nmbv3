...
/**
 * Generated class for the LoanenquiriesPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-loanenquiries',
  templateUrl: 'loanenquiries.html',
})
export class LoanenquiriesPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad LoanenquiriesPage');
  }
public openModal(){ 
   
   let template="<div>Your Loan Balance is:<br>Kshs: 5,000,and is due 20th May</div>";
